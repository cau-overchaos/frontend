    ...
    return <div className={popupStyles.container}>
        <div className={popupStyles.popup}>
            <div className={classNames(popupStyles.top, styles.profile)}>
                <div className={styles.image} style={props.backgroundUrl ? { backgroundImage: `url(${props.backgroundUrl})` } : {}}></div>
            ...
            <div className={popupStyles.bottom}>
                <ul className={styles.menu}>
                    ...
                    {props.loggedIn &&
                        <li>
                            <a href="#">
                                <FontAwesomeIcon className={styles.icon} icon={faCog}></FontAwesomeIcon>
                                <span>설정</span>
                            </a>
                        </li>
                    }
